...
| <a name="input_traefik_domain"></a> [traefik\_domain](#input\_traefik\_domain) | Domain for traefik | `string` | `null` | no |
| <a name="input_traefik_enabled"></a> [traefik\_enabled](#input\_traefik\_enabled) | For enabling traefik | `bool` | `true` | no |
