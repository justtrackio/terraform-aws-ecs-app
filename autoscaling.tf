locals {
  ...
  mpr_enabled                         = lookup(module.this.tags, "Type") == "gateway" ? false : lookup(module.this.tags, "Type") == "subscriber" || lookup(module.this.tags, "Type") == "consumer" && var.mpr_enabled == null ? true : var.mpr_enabled
